...
class ARJoystickSKScene: SKScene {
  ...
  lazy var analogJoystick: AnalogJoystick = {
    ...
    lazy var threeDJoystick: AnalogJoystick = {
        let tjs = AnalogJoystick(diameter: 100, colors: nil, images: (substrate: #imageLiteral(resourceName: "jSubstrate"), stick: #imageLiteral(resourceName: "jStick3D")))
        tjs.position = CGPoint(x: tjs.radius + 45, y: tjs.radius + 45)
        return tjs
    }()
